/*
    ...
    GLSC2, OpenGL, OpenGL ES loader generated by glad 0.1.33 on Sun Aug 23 09:22:14 2020.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.6,gles2=3.2,glsc2=2.0,gles1=1.0" --generator="c" --spec="gl" --no-loader --local-files --extensions=""
    Online:
        https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&api=gl%3D4.6&api=gles2%3D3.2&api=glsc2%3D2.0&api=gles1%3D1.0
*/
